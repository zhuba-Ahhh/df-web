...
export const InfoCard = ({ item }: InfoCardProps) => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between bg-gray-800/80 backdrop-blur p-2 md:p-3 rounded-xl md:rounded-2xl shadow-lg hover:bg-gray-800/90 transition-all duration-300 border border-gray-700 space-y-1 md:space-y-0">
